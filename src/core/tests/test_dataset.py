...
class DatasetTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.TRANSFORMED_CSV_FILENAME = os.path.join(test_file_dir, TRANSFORMED_CSV_FILENAME)
        self.RAW_CSV_FILENAME = os.path.join(test_file_dir, RAW_CSV_FILENAME)
    ...
    def test_transform_negative(self):
        self.assertRaises(ValueError, datasets.transform, None)
        self.assertRaises(ValueError, datasets.transform, {})
    ...
    def test_transform(self):
        ...
        # WHEN
        result_filename, now = datasets.transform(test_dict)

        # THEN
        self.assertEqual(True, os.path.exists(result_filename))
